    ...
    >
      <div className="container mx-auto flex flex-col lg:flex-row items-center gap-6">
        <div className="flex-1 ">
          <h3 className="text-xl font-secondary text-orange-400 font-bold uppercase mb-6">
            Fast Delivery
          </h3>
          <h1 className="text-2xl lg:text-4xl xl:text-6xl font-primary font-bold text-[#19063c] text-left mb-6 leading-tight">
